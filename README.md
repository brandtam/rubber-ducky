...
The name comes from [rubber duck debugging](https://en.wikipedia.org/wiki/Rubber_duck_debugging) — the engineering technique where you explain your problem out loud to a rubber duck on your desk, and the act of articulating it helps you find the answer. Rubber-Ducky started when I was using speech-to-text with Claude Code and realized I was doing the rubber duck technique constantly — talking through my work, narrating decisions, thinking out loud. The problem was that all of that context evaporated at the end of every conversation. This tool makes the duck remember — and unlike the one on your desk, this one actually answers back.
