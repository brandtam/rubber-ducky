 ...
 * settings is a low-frequency surface, but anyone reusing this primitive
 * for higher-frequency state should add `proper-lockfile` around the
 * read-modify-write cycle in the caller.
 */
